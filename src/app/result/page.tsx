...
function LoadingFallback() {
  return (
    <div className="max-w-3xl mx-auto p-8 mt-16 mb-10 bg-[#05041c] rounded-2xl shadow-2xl shadow-[#347188]/20 border border-[#347188]/30 text-center">
      <div className="animate-pulse">
        <div className="h-8 bg-blue-800 rounded w-3/4 mx-auto mb-4"></div>
        <div className="h-4 bg-blue-700 rounded w-1/2 mx-auto mb-8"></div>
